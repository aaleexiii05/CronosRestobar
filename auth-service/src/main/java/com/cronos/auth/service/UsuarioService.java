package com.cronos.auth.service;

import com.cronos.auth.client.ConsultaClient;
import com.cronos.auth.dto.UsuarioDTO;
import com.cronos.auth.entity.Usuario;
import com.cronos.auth.repository.UsuarioRepository;
...
public class UsuarioService {
    ...
    public UsuarioDTO crear(UsuarioDTO dto) {
        ...
        if (dto.getDni() != null && (dto.getNombres() == null || dto.getNombres().isEmpty())) {
            try {
                Map<String, String> reniecData = consultaClient.consultarReniec(dto.getDni());
